...
if st.button('Show Recommendation'):
    ...
    with col1:
        ...
        st.text(recommended_movie_actors[1])
    ...
    with col2:
        ...
        st.text(recommended_movie_actors[2])
    ...
    with col3:
        ...
        st.text(recommended_movie_actors[3])
    ...
    with col4:
        ...
        st.text(recommended_movie_actors[4])
    ...
    with col5:
        ...
        st.text(recommended_movie_genres[5])
        st.text(recommended_movie_actors[5])
    ...
    with col6:
        ...
        st.text(recommended_movie_genres[6])
        st.text(recommended_movie_actors[6])
